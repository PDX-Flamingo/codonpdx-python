...
Copyright (c) 2014, Phil Tseng, Modified to include trie_increment
...
/**
 * Modified by Phil Tseng.  June 12, 2014
 * Increments a number value by one.
 *
 * @param trie               The trie.
 * @param key                The key to access the new value.
 * @return                   Non-zero if the value was incremented successfully,
 *                           or zero if it was not possible to allocate 
 *                           memory for the new entry.
 */

int trie_increment(Trie *trie, char *key);
